...
#line 83 "analisador_sintatico.tab.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ID = 6,                         /* ID  */
  YYSYMBOL_LITERALINT = 7,                 /* LITERALINT  */
  YYSYMBOL_LITERALFLOAT = 8,               /* LITERALFLOAT  */
  YYSYMBOL_IF = 9,                         /* IF  */
  ...
  YYSYMBOL_TRU = 20,                       /* TRU  */
  YYSYMBOL_FALS = 21,                      /* FALS  */
  YYSYMBOL_OPAR = 22,                      /* OPAR  */
  YYSYMBOL_CPAR = 23,                      /* CPAR  */
  YYSYMBOL_OBRAC = 24,                     /* OBRAC  */
